...
## Mezzio
You'll need to add a configuration and register the services you'd like to use.  
There are number of ways to do that, but the recommended way is to create a 
new config file `config/autoload/cache.global.php`
